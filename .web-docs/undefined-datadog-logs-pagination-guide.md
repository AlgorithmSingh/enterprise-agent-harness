# Datadog — Guide: Collect multiple logs with Pagination

- Source URL: https://docs.datadoghq.com/logs/guide/collect-multiple-logs-with-pagination.md
...
breadcrumbs: Docs > Log Management > Logs Guides > Collect multiple logs with Pagination
---
...
To retrieve a log list longer than the maximum 1000 logs limit returned by the [Logs API](https://docs.datadoghq.com/api/v1/logs.md#get-a-list-of-logs), you must use the Pagination feature.

You can retrieve logs from your Datadog site by sending a POST request to the appropriate API endpoint. Make sure to replace `<DATADOG_SITE>` in the URL with your actual Datadog site domain (``).
...
- [Discover how to process your logs](https://docs.datadoghq.com/logs/log_configuration/processors.md)
- [Learn more about parsing](https://docs.datadoghq.com/logs/log_configuration/parsing.md)
- [Datadog live tail functionality](https://docs.datadoghq.com/logs/live_tail.md)
- [See how to explore your logs](https://docs.datadoghq.com/logs/explorer.md)
- [Logging without limit*](https://docs.datadoghq.com/logs/logging_without_limits.md)
