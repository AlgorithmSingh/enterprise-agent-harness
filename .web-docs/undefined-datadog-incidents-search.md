# Datadog — Incidents API: Search for incidents (GET /api/v2/incidents/search)

- Source URL: https://docs.datadoghq.com/api/latest/incidents/search-for-incidents.md
...
| uk1.datadoghq.com | GET https://api.uk1.datadoghq.com/api/v2/incidents/search |
...
##### 
                  \# Required query arguments export query="CHANGE_ME" \# Curl command curl -X GET "https://api.datadoghq.com/api/v2/incidents/search?query=${query}" \
