/**
 * Optional OpenCode autopilot-mode loader.
 *
 ...
 * no autopilot tools. Every other import/configuration failure remains fatal.
 */
...
const server: Plugin = async (input) => {
  try {
    const loaded = await import("./retrieval-autopilot-tools.ts");
...
export default { id: "retrieval-autopilot-loader", server };
